...
export const SkillGroup: FC<PropsWithChildren<{ skillGroup: SkillGroupType }>> = memo(({ skillGroup }) => {
  ...
  return (
    <div className="flex flex-col gap-y-4 p-6 bg-white dark:bg-neutral-800 rounded-2xl shadow-sm border border-neutral-100 dark:border-neutral-700 hover:shadow-md transition-shadow duration-300">
  ...
  return (
    <div className="flex flex-col w-full gap-y-1">
      <div className="flex justify-between items-end mb-1">
        <span className="text-sm font-semibold text-neutral-700 dark:text-neutral-300">{name}</span>
